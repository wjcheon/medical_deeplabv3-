...
## %% train
batch_size = 10
train_X_batch = train_X[121:178, :, :, :]
train_Y_batch = train_Y[121:178, :, :, :]
...
for epoch in range(1000):
    ...
    l, _ = sess.run([loss, train], feed_dict={X: batch_x, Y: batch_y})
    print('{:}, training cost = {:.4f}'.format(epoch + 1, l))
